...
import { myProvider } from "../../../components/lib/ai/providers"
import { postRequestBodySchema, type PostRequestBody } from "../schema"
import { createResumableStreamContext, type ResumableStreamContext } from "resumable-stream"
import { after } from "next/server"
import { getTopicNamesTool, readAboutSueTool } from "../../../components/lib/ai/tools/sue-google-files"
        ...
        try {
          ...
          if (selectedChatModel === "chat-model-reasoning") {
            const result = streamText({
              ...
              system: `
              - You are an AI assistant that helps answer questions about Sue(Sheila Susan), in his portfolio website.
              `,
              messages,
              maxSteps: 5,
          ...
          const result = streamText({
            model: myProvider.languageModel(selectedChatModel),
            system: `You are an AI assistant that helps answer questions about Sue(Sheila Susan), in his portfolio website.
